...
public class OpLogicoBinarioAndTest {
	...
	private OpLogicoBinarioAnd opAnd;
	...
	public void setUp() {
		...
		this.opAnd = new OpLogicoBinarioAnd(mockedFiltro1, mockedFiltro2);
	}
	

	@Test
	public void testOpLogicoBinarioAnd_filtrar() {
		List<Muestra> lMuestras = this.opAnd.filtrar(new ArrayList<Muestra>());
